        ...
        <div className="container">
          ...
          >
            <div className="section-header">
              ...
              <h2 className="mb-0">Cursos em Alta</h2>
            </div>
            <div>
              ...
              <div className="course-box trend-box">
                ...
                >
                  ...
                  <div className="course-content">
                    ...
                    <h3 className="title">
                      <Link to={route.courseDetails}>
                        Aprenda JavaScript e Express para se tornar um
                        profissional em JavaScript
                      </Link>
                    </h3>
              ...
              <div className="course-box trend-box">
                ...
                >
                  ...
                  <div className="course-content">
                    ...
                    <h3 className="title">
                      <Link to={route.courseDetails}>
                        Fundamentos do Design Responsivo com HTML5, CSS3 e
                        Bootstrap
                      </Link>
                    </h3>
                    <div className="course-info d-flex align-items-center">
          ...
          <div className="feature-instructors">
            <div className="section-header text-center aos" data-aos="fade-up">
              ...
              <p className="mb-0">
                Nossa equipe combina design de ponta com desenvolvimento robusto
              </p>
            </div>
            <Slider {...trendingslider2} data-aos="fade-up">
              <div className="instructor-item instructor-item-two">
                <div className="instructors-img">
                  ...
                  <div className="position-absolute start-0 top-0 d-flex align-items-start w-100 z-index-2 p-3">
                    ...
                    <Link
                      to={route.courseList}
                      className="course-count ms-auto"
                    >
                      20 Cursos
                    </Link>
                  </div>
                ...
                <div className="instructor-content">
                  ...
                  <span className="designation">Desenvolvedor Web</span>
              ...
              <div className="instructor-item instructor-item-two">
                ...
                <div className="instructor-content">
                  ...
                  <span className="designation">Especialista em PHP</span>
                  <div className="student-count">
              ...
              <div className="instructor-item instructor-item-two">
                ...
                <div className="instructor-content">
                  ...
                  <span className="designation">Desenvolvedora Web</span>
                  <div className="student-count">
              ...
              <div className="instructor-item instructor-item-two">
                ...
                <div className="instructor-content">
                  ...
                  <span className="designation">Designer de UI</span>
                  <div className="student-count">
