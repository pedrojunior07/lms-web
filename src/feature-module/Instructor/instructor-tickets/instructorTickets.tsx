...
import { TicketsData } from "../../../core/common/data/json/ticketsData";
  ...
  const columns = [
    {
      ...
      dataIndex: "TicketID",
      render: (text: string) => (
        <Link to="#" data-bs-toggle="modal" data-bs-target="#ticket_details">
          {text}
        </Link>
      ),
                ...
                <div className="row">
                  ...
                  <div className="col-lg-12">
                    <div>
                      ...
                      <p>
                        I am not receiving important emails from the LMS
                        platform, such as course notifications, enrollment
                        confirmations, or assignment updates. Additionally, some
                        students have reported that they are not receiving
                        emails about live classes or announcements. This issue
                        is affecting communication and timely updates for both
                        instructors and students. Please investigate and resolve
